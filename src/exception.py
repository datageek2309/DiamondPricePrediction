...
class CustomExpection(Exception):
    ...
    def __init__(self,error_message:str,error_detail:sys) -> None:
        ...
        self.error_message=CustomExpection.error_message_detail(error=error_message,error_detail=error_detail)
    
    @classmethod
    def error_message_detail(cls,error:str,error_detail:sys)->str:
        try:
